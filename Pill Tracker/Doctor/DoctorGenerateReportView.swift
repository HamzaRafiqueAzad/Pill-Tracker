//
//  DoctorGenerateReportView.swift
//  Pill Tracker
//
//  Created by Hamza Rafique Azad on 22/8/23.
//

import SwiftUI

struct DoctorGenerateReportView: View {
...
struct DoctorGenerateReportView_Previews: PreviewProvider {
    static var previews: some View {
        DoctorGenerateReportView(firebaseManager: FirebaseManager())
    }
}
