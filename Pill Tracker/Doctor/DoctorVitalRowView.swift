...
struct DoctorVitalRowView: View {
...
struct DoctorVitalRowView_Previews: PreviewProvider {
    static var previews: some View {
        DoctorVitalRowView(firebaseManager: FirebaseManager(), vital: Vital(id: UUID(), type: .heartRate, value: 100.0, date: Date().timeIntervalSince1970))
    }
}
